...
namespace cma.cimiss.demo.rest.StaInfoSearchAPI
{
    /*
     * rest 调取，台站信息检索，返回text格式字符串
     */
    class StaInfoSearchAPI_REST_rest_TEXT
    {
        /*
	     * main方法，程序入口 
       ...
       static void Main1(string[] args) {
           ...
           new StaInfoSearchAPI_REST_rest_TEXT().test();
       }
       public void test()
       {
		/* 1. 调用方法的参数定义，并赋值 */

...
{
    /*
    * 客户端调取，文件信息列表检索，返回html格式的文件列表信息
    */
    class FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_HTML
    {
        ...
        **/
        static void Main1(string[] args) {
            ...
            new FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_HTML().test();
        }
	public void test(){
		/* 1. 定义client对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_HTML.");

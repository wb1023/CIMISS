...
namespace cma.cimiss.demo.clib.FileInfoSearchAPI
{
    ...
    */
    class FileInfoSearchAPI_CLIB_callAPI_to_downFile
    {
    ...
    */
    static void Main1(string[] args) {
        ...
        new FileInfoSearchAPI_CLIB_callAPI_to_downFile().test();
    }
    public void test()
    {
        /* 1. 定义client对象 */
        ...
        param.Add("timeRange", "[20141009123000,20141009123600)"); //时间段，前闭后开
        ...
        try
        {
            ...
            //调用接口
            int rst = client.callAPI_to_downFile(userId, pwd, interfaceId, param, saveDir, retFilesInfo);
            //输出结果
            if (rst == 0)
            { //正常返回
            ...
            { //异常返回
                Console.WriteLine("[error] FileInfoSearchAPI_CLIB_callAPI_to_downFile.");

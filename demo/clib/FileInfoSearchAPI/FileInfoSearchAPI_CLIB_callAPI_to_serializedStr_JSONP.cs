...
namespace cma.cimiss.demo.clib.FileInfoSearchAPI
{
     ...
     */
    class FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP
    {
	    ...
	    **/
        static void Main1(string[] args) {
            ...
            new FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP().test();
        }
       public void test(){
		/* 1. 定义client对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP.");

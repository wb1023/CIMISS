...
{
    /*
     * 客户端调取，站点资料检索，返回KML格式字符串
     * 未能正确运行-202
     */
    class StaElemSearchAPI_CLIB_callAPI_to_serializedStr_KML
    {
        /* 1. 定义client对象 */
	   ...
	   */
       static void Main1(string[] args) {
           ...
           new StaElemSearchAPI_CLIB_callAPI_to_serializedStr_KML().test();
	    }
       public void test()
       {
		/* 1. 定义client对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaElemSearchAPI_CLIB_callAPI_to_serializedStr_KML." ) ;       

...
{
    /*
     * 客户端调取，站点资料检索，返回XML字符串
     */
    class StaElemSearchAPI_CLIB_callAPI_to_serializedStr_XML
    {
        /* 1. 定义client对象 */
        ...
        */
        static void Main1(string[] args) {
            ...
            new StaElemSearchAPI_CLIB_callAPI_to_serializedStr_XML().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
        ...
        try {
          ...
          if(rst == 0) { //正常返回
            ...
            Console.WriteLine( "[error] StaElemSearchAPI_CLIB_callAPI_to_serializedStr_XML." ) ;       

...
{
    /*
     * 客户端调取，站点资料检索，返回TXT文件并下载到本地，且返回RetFilesInfo对象
     */
    class StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT
    {
        ...
        */
        static void Main1(string[] args) {
            ...
            new StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
	    ...
	    /* 2.5 文件的本地全路径 */
	    string savePath = "e:/temp/StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT.txt" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT." ) ;       

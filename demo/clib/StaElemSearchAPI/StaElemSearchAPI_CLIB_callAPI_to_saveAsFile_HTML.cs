...
{
    /*
     * 客户端调取，站点资料检索，返回HTML文件并下载到本地，且返回RetFilesInfo对象
     */
    class StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_HTML
    {
       ...
       static void Main1(string[] args) {
            ...
            new StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_HTML().test();
        }
       public void test()
       {
		/* 1. 定义client对象 */
	   ...
	   param.Add("orderby", "Station_ID_C:ASC") ; //排序：按照站号从小到大
	    ...
	    /* 2.5 文件的本地全路径 */
	    string savePath = "e:/temp/StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_HTML.html" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_HTML." ) ;       

...
namespace cma.cimiss.demo.clib.StaElemSearchAPI
{
     ...
     */
    class StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_XML
    {
        /* 1. 定义client对象 */
        ...
        */
        static void Main1(string[] args) {
            ...
            new StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_XML().test();
        }
        public void test()
        {
		    /* 1. 定义client对象 */
            ...
            /* 2.5 文件的本地全路径 */
            string savePath = "e:/temp/StaElemSearchAPI_CLIB_callAPI_to_saveAsFile_XML.xml" ;
            /* 2.6 返回文件的描述对象 */

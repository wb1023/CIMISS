...
{
    /*
    * 客户端调取，格点要素抽取，存储kml格式字符串
    * 运行错误-202 
    */
    class GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_KML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args)
        {
            ...
            new GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_KML().test();
        }
        public void test()
        {
            ...
            try
            {
                ...
                { // 异常返回
                    Console.WriteLine("[error] GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_KML.");

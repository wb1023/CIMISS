...
namespace cma.cimiss.demo.clib.GridElemPointSearchAPI
{
     ...
     */
    class GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_JSON
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_JSON().test();
        }
        public void test(){
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_JSON.");

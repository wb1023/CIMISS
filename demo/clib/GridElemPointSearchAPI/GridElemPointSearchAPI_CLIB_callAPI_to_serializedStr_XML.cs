...
{
    /*
     * 客户端调取，格点要素抽取，存储xml格式字符串
     */
    class GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_XML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_XML().test();
        }
        public void test(){
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] GridElemPointSearchAPI_CLIB_callAPI_to_serializedStr_XML.");

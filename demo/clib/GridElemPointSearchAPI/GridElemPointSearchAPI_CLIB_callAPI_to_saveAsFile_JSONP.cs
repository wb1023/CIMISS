...
namespace cma.cimiss.demo.clib.GridElemPointSearchAPI
{
     ...
     */
    class GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_JSONP
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_JSONP().test();
        }
        public void test(){
		/* 1. 定义client对象 */
        ...
        param.Add("callbackName", "apiData");
		// 可选参数
		// param.Add("fcstMember", "1"); //集合预报成员（单个)：从1开始
		/* 2.4 返回文件的格式 */
		string dataFormat = "json";
		/* 2.5 文件的本地全路径 */
		string savePath = "e:/temp/GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_JSONP.json";
		/* 2.6 返回文件的描述对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_JSONP");

...
{
    /*
     * 客户端调取，格点要素抽取，存储kml文件对象
     */
    class GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_KML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args)
        {
            ...
            new GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_KML().test();
        }
       public void test()
        {
            /* 1. 定义client对象 */
            ...
            /* 2.5 文件的本地全路径 */
            string savePath = "e:/temp/GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_KML.kml";
            /* 2.6 返回文件的描述对象 */

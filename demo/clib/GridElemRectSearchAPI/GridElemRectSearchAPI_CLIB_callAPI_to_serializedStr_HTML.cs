...
namespace cma.cimiss.demo.clib.GridElemRectSearchAPI
{
     ...
     */
    class GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_HTML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_HTML().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_HTML.");

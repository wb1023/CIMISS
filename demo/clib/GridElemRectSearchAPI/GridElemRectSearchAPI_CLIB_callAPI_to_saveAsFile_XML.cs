...
namespace cma.cimiss.demo.clib.GridElemRectSearchAPI
{
     ...
     * 格点场要素获取（切块），写XML文件
     */
    class GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_XML
    {
       ...
       static void Main1(string[] args) {
           ...
           new GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_XML().test();
       }
       public void test()
       {
		/* 1. 定义client对象 */
		...
		/* 2.5 文件的本地全路径 */
		string savePath = "e:/temp/GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_XML.xml";
		/* 2.6 返回文件的描述对象 */

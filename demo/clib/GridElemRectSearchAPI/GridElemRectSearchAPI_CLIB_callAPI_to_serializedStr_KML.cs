...
namespace cma.cimiss.demo.clib.GridElemRectSearchAPI
{
    /*
     * 客户端调取，
     * 格点场要素获取（切块），写KML格式字符串
     * 运行错误-202
     */
    class GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_KML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args)
        {
            ...
            new GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_KML().test();
        }
        public void test()
        {
            /* 1. 定义client对象 */
            ...
            /* 2.5 文件的本地全路径 */
            string savePath = "e:/temp/GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_KML.kml";
            /* 2.6 返回文件的描述对象 */
            ...
            try
            {
                ...
                { // 异常返回
                    Console.WriteLine("[error] GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_KML.kml");

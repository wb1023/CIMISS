...
namespace cma.cimiss.demo.clib.GridElemRectSearchAPI
{
    /*
     * 客户端调取，
     * 格点场要素获取（切块），写XML格式字符串
     */
    class GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_XML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_XML().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] GridElemRectSearchAPI_CLIB_callAPI_to_serializedStr_XML.");

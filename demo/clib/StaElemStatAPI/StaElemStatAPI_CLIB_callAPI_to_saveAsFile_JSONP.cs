...
{
    /*
     * 客户端调取，站点要素统计，存储为json格式
     */
    class StaElemStatAPI_CLIB_callAPI_to_saveAsFile_JSONP
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new StaElemStatAPI_CLIB_callAPI_to_saveAsFile_JSONP().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
		...
		param.Add("elements", "Station_ID_C,Lat,lon");
	    ...
	    /* 2.5 文件的本地全路径 */
	    string savePath = "e:/temp/StaElemStatAPI_CLIB_callAPI_to_saveAsFile_JSONP.json" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaElemStatAPI_CLIB_callAPI_to_saveAsFile_JSONP." ) ;       

...
{
    /*
     * 客户端调取，站点要素统计，序列化为xml格式字符串
     */
    class StaElemStatAPI_CLIB_callAPI_to_serializedStr_XML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new StaElemStatAPI_CLIB_callAPI_to_serializedStr_XML().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaElemStatAPI_CLIB_callAPI_to_serializedStr_XML." ) ;       

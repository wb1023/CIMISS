...
namespace cma.cimiss.demo.clib.StaInfoSearchAPI
{
     ...
     * 运行错误
     */
    class StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_KML
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_KML().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
		...
		param.Add("elements", "Lat,Lon,Alti"); // 检索要素：站号、站名、纬度、经度、高度
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_KML.");

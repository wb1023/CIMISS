...
{
    /*
     * 客户端调取，台站信息检索，返回RetArray2D对象
     */
    class StaInfoSearchAPI_CLIB_callAPI_to_array2D
    {
        ...
        static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_array2D().test();
		}
        public void test()
        {
		/* 1. 定义client对象 */
        ...
        clibUtil.outputRst( retArray2D ) ;
				...
				Console.WriteLine( "[error] StaInfoSearchAPI_CLIB_callAPI_to_array2D." ) ;				

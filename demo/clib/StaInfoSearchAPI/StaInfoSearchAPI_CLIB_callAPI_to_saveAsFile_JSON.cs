...
namespace cma.cimiss.demo.clib.StaInfoSearchAPI
{
     ...
     */
    class StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_JSON
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_JSON().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
	    ...
	    /* 2.5 文件的本地全路径 */
	    string savePath = "e:/temp/StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_JSON.json" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_JSON." ) ;       

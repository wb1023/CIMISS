...
{
    /*
     * 客户端调取，台站信息检索，返回Kml格式
     * 未能正常运行
     */
    class StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_KML
    {
        /* 1. 定义client对象 */
         ...
         */
         static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_KML().test();
        }
         public void test()
         {
		/* 1. 定义client对象 */
	    ...
	    /* 2.5 文件的本地全路径 */
	    string savePath = "e:/temp/StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_KML.kml" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	      ...
	      if(rst == 0) { //正常返回
	        ...
	        Console.WriteLine( "[error] StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_KML." ) ;       

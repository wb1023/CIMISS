...
namespace cma.cimiss.demo.clib.StaInfoSearchAPI
{
     ...
     */
    class StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP
    {
        /* 1. 定义client对象 */
        ...
        static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP().test();
        }
        public void test()
        {
		/* 1. 定义client对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_JSONP.");

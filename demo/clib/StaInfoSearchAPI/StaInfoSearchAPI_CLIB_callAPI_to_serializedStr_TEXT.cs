...
{
    /*
    * 客户端调取，台站信息检索，返回TEXT格式字符串
    */
    class StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_TEXT
    {
        /* 1. 定义client对象 */
       ...
       static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_TEXT().test();
        }
       public void test()
       {
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				Console.WriteLine("[error] StaInfoSearchAPI_CLIB_callAPI_to_serializedStr_TEXT.");

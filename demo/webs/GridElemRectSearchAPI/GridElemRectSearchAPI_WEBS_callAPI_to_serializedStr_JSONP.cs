...
{
    /*
     * web service调取，格点场要素获取（切块），返回json字符串
     */
    class GridElemRectSearchAPI_WEBS_callAPI_to_serializedStr_JSONP
    {
        /*
	     * main方法 
        ...
        static void Main1(string[] args) {
            ...
            new GridElemRectSearchAPI_WEBS_callAPI_to_serializedStr_JSONP().test();
        }
        public void test()
        {
		/* 1. 调用方法的参数定义，并赋值 */

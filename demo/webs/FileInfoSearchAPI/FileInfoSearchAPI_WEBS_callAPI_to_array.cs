...
namespace cma.cimiss.demo.webs.FileInfoSearchAPI
{
    ...
    /*
     * web service调取，文件信息列表检索，返回二维数组
     */
    class FileInfoSearchAPI_WEBS_callAPI_to_array
    {
        /*
        * main方法
        ...
        */
        static void Main1(string[] args) {
            ...
            new FileInfoSearchAPI_WEBS_callAPI_to_array().test();
        }
        public void test()
        {
        /* 1. 调用方法的参数定义，并赋值 */
        ...
        //wsPortType wsPort = new wsPortType();

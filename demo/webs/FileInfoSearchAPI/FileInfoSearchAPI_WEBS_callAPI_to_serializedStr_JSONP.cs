...
{
    /*
     * web service调取，文件信息列表检索，返回json格式
     */
    class FileInfoSearchAPI_WEBS_callAPI_to_serializedStr_JSONP
    {
        /*
	   * main方法
	   ...
	   */
        static void Main1(string[] args) {
            ...
            new FileInfoSearchAPI_WEBS_callAPI_to_serializedStr_JSONP().test();
        }
        public void test()
        {
	    /* 1. 调用方法的参数定义，并赋值 */

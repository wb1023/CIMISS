...
namespace cma.cimiss.demo.webs.GridElemPointSearchAPI
{
    /**
     * 未实现接口 20140911
     * ReturnMessage	other exception. detail: The interface cannot call string[][]!
     *
     */
    class GridElemPointSearchAPI_WEBS_callAPI_to_array
    {
        /*
	     * main方法 
        ...
        static void Main1(string[] args) {
            ...
            new GridElemPointSearchAPI_WEBS_callAPI_to_array().test();
        }
        public void test()
        {
		/* 1. 调用方法的参数定义，并赋值 */

...
{
    /*
     * web service调取，返回JSON格式
     */
    class GridElemPointSearchAPI_WEBS_callAPI_to_serializedStr_JSONP
    {
        /*
	     * main方法 
        ...
        static void Main1(string[] args) {
            ...
            new GridElemPointSearchAPI_WEBS_callAPI_to_serializedStr_JSONP().test();
        }
        public void test()
        {
		/* 1. 调用方法的参数定义，并赋值 */

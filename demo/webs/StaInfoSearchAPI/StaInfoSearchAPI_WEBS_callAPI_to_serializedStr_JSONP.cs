...
{
    /*
     * web service调取，站点信息检索，返回JSON字符串
     */
    class StaInfoSearchAPI_WEBS_callAPI_to_serializedStr_JSONP
    {
        /*
	     * main方法，程序入口 
        ...
        static void Main1(string[] args) {
            ...
            new StaInfoSearchAPI_WEBS_callAPI_to_serializedStr_JSONP().test();
        }
        public void test()
        {
		/* 1. 调用方法的参数定义，并赋值 */
